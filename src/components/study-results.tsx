...
export default function StudyResults({
  ...
  function showOutput(
    ...
    return generatedOutputs.includes(
      outputId,
    );
  }
              ...
              <div className="mt-6 space-y-3">
                {studyPack.actionPoints.map(
                  (
                    ...
                    return (
                      <button
                        key={`${actionPoint.task}-${actionIndex}`}
                        type="button"
                        aria-pressed={
                          isCompleted
                        }
                      ...
                      >
                        ...
                        <span className="min-w-0 flex-1">
                          <span className="flex flex-col justify-between gap-2 sm:flex-row sm:items-start">
                            ...
                            <span
                              className={`shrink-0 rounded-full px-3 py-1 text-xs font-bold ${priority.className}`}
                            >
                              {
                                priority.label
                              }
